...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux" OR APPLE OR (CMAKE_SYSTEM_NAME STREQUAL "FreeBSD" AND HAVE_FREEBSD_XLOCALE))
...
if(NOT ICU_FOUND AND NOT ICONV_FOUND AND NOT WIN32)
...
if(WIN32 AND (BOOST_LOCALE_ENABLE_WINAPI_BACKEND OR BOOST_LOCALE_ENABLE_STD_BACKEND))
  target_sources(Boost_locale PRIVATE
