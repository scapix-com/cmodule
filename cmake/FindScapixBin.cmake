...
set(SCAPIX_EXE "${CMODULE_scapix_bin_SOURCE_DIR}/${CMAKE_HOST_SYSTEM_NAME}-${CMAKE_HOST_SYSTEM_PROCESSOR}/scapix")

if(NOT EXISTS "${SCAPIX_EXE}")
  string(APPEND SCAPIX_EXE ".exe")
endif()

set(SCAPIX_JAVA_EXE "${CMODULE_scapix_bin_SOURCE_DIR}/${CMAKE_HOST_SYSTEM_NAME}-${CMAKE_HOST_SYSTEM_PROCESSOR}/scapix_java")

if(NOT EXISTS "${SCAPIX_JAVA_EXE}")
  string(APPEND SCAPIX_JAVA_EXE ".exe")
endif()
